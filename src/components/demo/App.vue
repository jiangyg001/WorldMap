...
<script>
 ...
 export default {
          ...
          methods: {
              ...
              //BMI 国家风险折线图
              slidebarCharts(param) {
                  let myChart = echarts.init(document.getElementById('slidebarCharts'));
                  let option = {
                      // title: {
                      //     text: 'BMI 国家风险折线图'
                      // },
                  ...
                  myChart.setOption(option, true);
                            ...
                            //WB世界发展
              slidebarOtherCharts(param) {
                  let myChart = echarts.init(document.getElementById('slidebarOtherCharts'));
                 let option = {
                     // title:{
                     //   text:"WB世界发展"
                     // },
              ...
              //WB世界发展
              slidebaranOtherCharts(param) {
                  let myChart = echarts.init(document.getElementById('slidebaranOtherCharts'));
                  // Generate data
                  var category = [];
              ...
              //WB世界发展
              insertotherCharts(param) {
                  let myChart = echarts.init(document.getElementById('insertotherCharts'));
                  // Generate data
              ...
              rightTwoCharts(param) {
                  ...
                  myChart.setOption(option);
                            ...
                            //  横向柱形图charts生成方法
              rightThreeCharts(param) {
                  // 基于准备好的dom，初始化echarts实例
                  let myChart = echarts.init(document.getElementById('rightThreeCharts'))
                  // 绘制图表
                   var pathSymbols = {
          ...
          mounted() {
            ...
            this.slidebarCharts();
            this.insertotherCharts();
            this.slidebarOtherCharts();
            this.slidebaranOtherCharts();
            ...
            window.onresize = function temp() {
              ...
              self.slidebarCharts();
              self.insertotherCharts();
              self.slidebarOtherCharts();
              self.slidebaranOtherCharts();
